...
DEFAULT_IPAD_OUTPUT = SCRIPT_DIR / "miquan_ipad_reviews.csv"
DEFAULT_IPAD_RATINGS_OUTPUT = SCRIPT_DIR / "miquan_ipad_ratings.csv"
DEFAULT_IPAD_DEBUG_DIR = SCRIPT_DIR / "debug_ipad"
...
def main() -> None:
    ...
    parser.add_argument(
        "--skip-ratings-from",
        type=Path,
        default=SCRIPT_DIR / "miquan_ratings.csv",
