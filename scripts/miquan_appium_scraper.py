...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=RATINGS_DIR / "miquan_reviews.csv")
    parser.add_argument("--ratings-output", type=Path, default=RATINGS_DIR / "miquan_ratings.csv")
    parser.add_argument(
        "--mode",
