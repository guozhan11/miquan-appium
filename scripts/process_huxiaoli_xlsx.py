...
DEFAULT_INPUT = DATA_DIR / "sources" / "狐小狸剧本杀.xlsx"
DEFAULT_OUTPUT = DATA_DIR / "search_terms" / "huxiaoli_search_terms.csv"
DEFAULT_VIEW_OUTPUT = DATA_DIR / "search_terms" / "huxiaoli_search_terms_for_viewing.csv"
DEFAULT_RATINGS_OUTPUT = RATINGS_DIR / "huxiaoli_ipad_ratings.csv"
DEFAULT_REVIEWS_OUTPUT = RATINGS_DIR / "huxiaoli_ipad_reviews.csv"
DEFAULT_DEBUG_DIR = PROJECT_DIR / "logs" / "debug_huxiaoli_ipad"
DEFAULT_SKIP_RATINGS_FROM = [
    RATINGS_DIR / "miquan_ipad_ratings.csv",
    RATINGS_DIR / "miquan_ratings.csv",
]
